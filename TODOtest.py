...
parser.add_argument('--latest_generator_model', required=True, default='', help='the latest trained model path')
...
image_src = utils.data_load(os.path.join('data', args.image_dir), 'test', src_transform, 1, shuffle=True, drop_last=True)
